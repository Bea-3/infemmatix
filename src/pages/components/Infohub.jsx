...
const Infohub = () => {
  return (
    <div className='w-full min-h-[400px] border flex gap-5'>
        <div className='w-auto'>
        <img src={infohubImg} alt="Info hub image" /></div>
        <div className='text-primaryText flex flex-col justify-center gap-5 w-2/3 py-4 px-6'>
