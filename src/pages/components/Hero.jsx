...
const Hero = () => {
  return (
    <div className=' w-full min-h-[400px] flex pt-9 absolute top-40 hero z-5'>
        <div className='max-w-[500px] flex flex-col gap-9 justify-center m-3 hero-content'>
            ...
            <div className='w-2/3 flex gap-4 p-2 hero-content_buttons'>
                <button className='py-1 md:py-2 px-4 rounded-lg bg-primaryPurple '>Get Started</button>
